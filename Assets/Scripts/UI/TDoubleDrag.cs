...
/// <summary>
/// 这个类直接copy自TDrag
/// 这个类的目的单纯是为了解决listPanel内容随标题栏移动的问题
/// 不可复用，但解决了问题
/// </summary>
public class TDoubleDrag : MonoBehaviour, IPointerDownHandler, IDragHandler,IPointerEnterHandler,IPointerExitHandler {  
	...
	//联动区域
	[SerializeField]
	public RectTransform OtherLeftTrm;//左边区域
	float OtherLeftW;
	[SerializeField]
	public RectTransform OtherRightTrm;//右边区域
	float OtherRightX;
	...
	void Awake () {  
		...
		OtherLeftW = OtherLeftTrm.sizeDelta.x;
		OtherRightX = OtherRightTrm.offsetMin.x;
	}  
	...
	public void OnDrag (PointerEventData data) {  
		...
		if (RectTransformUtility.ScreenPointToLocalPointInRectangle (parentRectTransform, data.position, data.pressEventCamera, out localPointerPosition)) {  
			...
			OtherLeftTrm.sizeDelta = new Vector2(LeftW + offsetToOriginal.x,OtherLeftTrm.sizeDelta.y);
			OtherRightTrm.offsetMin = new Vector2 (RightX+offsetToOriginal.x,OtherRightTrm.offsetMin.y);
